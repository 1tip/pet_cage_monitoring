...
#define WDT_TIMEOUT 10    // 10초 동안 응답 없으면 재부팅
...
<body>
    <div class="container">
        ...
        <a href="/config" class="menu-button">Network & Admin</a>   <a href="/ntpconfig" class="menu-button">Time Sync (NTP)</a> <a href="/remote" class="menu-button">Remote Control</a>
        <a href="/sensorconfig" class="menu-button">Device Settings</a> <a href="/downloadlog" class="menu-button download-button">Download Log File</a>
    </div>
</body>
</html>)rawliteral";
